...
@OPTIMIZER_BUILDERS.register_module()
class TSMContrastiveHeadOptimizerConstructor(DefaultOptimizerConstructor):
    """Optimizer constructor in TSM model.
...
@OPTIMIZER_BUILDERS.register_module()
class TSMFreezeFCLayerOptimizerConstructor(DefaultOptimizerConstructor):
    def add_params(self, params, model):
        """Add parameters and their corresponding lr and wd to the params.
