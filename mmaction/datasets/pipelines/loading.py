...
class SampleFrames:
    ...
    Args:
        ...
        frame_interval (int): Temporal interval of adjacent sampled frames.
            Default: 1.
        temp_aug (str) : than we will use tempoeral augmentation
    ...
    def __init__(self,
                 ...
                 frame_interval=1,
                 temporal_aug = False,
                 multi_path_aug = False,
                 multi_path_aug_k1 = False,
                 num_clips=1,
        ...
        self.multi_path_aug = multi_path_aug
        self.multi_path_aug_k1 = multi_path_aug_k1
    ...
    def __call__(self, results):
        ...
        if self.temporal_aug:
            ...
            frame_inds_ = clip_offsets[:, None] + np.arange(
            self.clip_len)[None, :] * interval
        elif self.multi_path_aug:
            interval = random.randint(1, 4)
        ...
        #print('frame_inds.reshape((-1, self.clip_len))', frame_inds)
        # print('frame_inds22222', frame_inds)
        #print(self.out_of_bound_opt)
        if self.out_of_bound_opt == 'loop':
            frame_inds = np.mod(frame_inds, total_frames)
            #changed this part cuz of the error when in increase
            #frame_inds = np.mod(frame_inds, total_frames)
        ...
        #print("results['frame_inds']", results['frame_inds'])
        if self.reverse:
