...
class Kinetics400UCFHMDB(BaseDataset):
    ...
    def __init__(self,
        ...
        if not isinstance(domain, list):
            domain = [domain] 
        for d in domain:
            metadata_path = f"/data/jongmin/projects/dataset/{d}_{self.split}.csv"
...
#------------------------------------------------------
@DATASETS.register_module()
class Kinetics400_2_UCFHMDB(BaseDataset):
...
@DATASETS.register_module()
class Kinetics400UCFHMDBMultipleContrastiveSpaces(BaseDataset):
    def __init__(self,
                 domain,
                 pipelines,
                 test_mode=False,
