...
@LOSSES.register_module()
class SingleInstanceContrastiveLossv2_sum_positive(BaseWeightedLoss):
    def __init__(self, loss_weight=1.0, temperature=0.2, name=None, # other contrastiv method temperature=0.07
                use_row_sum_a=False,
                use_row_sum_b=False,
                use_positives_in_denominator=False):
    ...
    def _forward(self, features_a, features_b):
        ...
        # print('sum_column', row_sum_cross)
        # row_sum_cross_col = cross_similarity.sum(1)
        # print('sum_row', row_sum_cross_col)
