...
class moco_prediction_MLP(nn.Module):
    def __init__(self,
                 feature_size,
                 init_std=0.001,
                 middle_layer_dim=4096,
                 img_dim=256,
                 **kwargs):
...
@HEADS.register_module()
class moco_projection_MLP(nn.Module):
    def __init__(self,
                 feature_size,
                 num_segments,
                 init_std=0.001,
        ...
        self.BN1 = nn.BatchNorm1d(middle_layer_dim)
        self.relu_1 = nn.ReLU(inplace=True)
        self.fc2 = nn.Linear(middle_layer_dim, middle_layer_dim, bias=False)
        self.BN2 = nn.BatchNorm1d(middle_layer_dim)
        self.relu_2 = nn.ReLU(inplace=True)
        self.fc3 = nn.Linear(middle_layer_dim, img_dim, bias=False)
...
@HEADS.register_module()
class moco_projection_MLP_avg(nn.Module):
    def __init__(self,
                 feature_size,
                 num_segments,
                 init_std=0.001,
