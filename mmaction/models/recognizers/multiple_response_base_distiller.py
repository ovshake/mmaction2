...
class Multiple_response_baseDistillerRecognizer(Recognizer2D):
    def __init__(self,
                 backbone,
                 cls_head=None,
                 speed_network=None,
    ...
    def forward_train(self, imgs, labels, **kwargs):
        ...
        with torch.no_grad():
            ...
            if self.color_network:
                ...
                print('t_color_emb shape', t_color_emb.shape)
                t_color_emb = self.color_network.cls_head(t_color_emb)
                print('t_color_emb', t_color_emb.shape)
                # y = None
                # if y==None:
                #     assert print('stop------------')
                # t_color_emb = self.color_network(imgs, labels)
                # print('t_color_emb - ',t_color_emb.shape)
                y = None
                if y==None:
                    assert print('stop------------')
