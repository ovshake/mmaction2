...
model = dict(
            backbone=dict(type='ResNetTSM',
                ...
                shift_div=8),
            cls_head=dict(num_segments=8,dropout_ratio=0.0,in_channels=2048, num_classes=12))
...
# dataset settings
dataset_type = 'RawframeDataset'
data_root = '/local_datasets/ucf101/rawframes'
data_root_val = '/local_datasets/ucf101/rawframes'
ann_file_train = '/data/jongmin/projects/mmaction2_paul_work/data_list/train_ucf.txt'
ann_file_val = '/data/jongmin/projects/mmaction2_paul_work/data_list/test_ucf.txt'
ann_file_test = '/data/jongmin/projects/mmaction2_paul_work/data_list/test_ucf.txt'
