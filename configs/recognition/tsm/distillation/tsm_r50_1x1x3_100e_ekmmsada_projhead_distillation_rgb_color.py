...
color_model = dict(
            ...
            backbone=dict(type='ResNetTSM',
                depth=50,
                pretrained="/data/shinpaul14/projects/mmaction2/work_dirs/tsm_r50_1x1x3_100e_ekmmsada_rgb_color_simsiam/tsm-k400-color-simsiam_sp_pathway_B_color/train_D1_test_D1/best_top1_acc_epoch_100.pth",
                norm_eval=False,
                norm_cfg=dict(type='SyncBN', requires_grad=True),
                shift_div=8),
            cls_head=None,
