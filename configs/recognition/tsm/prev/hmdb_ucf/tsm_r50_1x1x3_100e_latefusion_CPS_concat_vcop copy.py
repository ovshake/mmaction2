...
model = dict(
            type='LateFusionRecognizer_all_in_one_ucf_hmdb_clip',
            backbone=dict(type='ResNetTSM',
                depth=50,
                norm_eval=False,frozen_stages=4,
                norm_cfg=dict(type='SyncBN', requires_grad=True),
                shift_div=8),
            cls_head=None,
            CPS_network=CPS_model,
            # color_network=CPS_model,
...
train_dataset_type = 'UCF_to_HMDB_ensemble'
val_dataset_type = 'UCF_to_HMDB'
img_norm_cfg = dict(
