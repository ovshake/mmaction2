...
fast_train_pipeline = [
    dict(type='SampleFrames', clip_len=fast_clip_len, frame_interval=2, num_clips=1),
...
data = dict(
    videos_per_gpu=12, # change batch size 
    workers_per_gpu=2,
...
optimizer = dict(
    ...
    momentum=0.9,
    weight_decay=0.0001) # if you changed the batch size change this part to change the learning rate
