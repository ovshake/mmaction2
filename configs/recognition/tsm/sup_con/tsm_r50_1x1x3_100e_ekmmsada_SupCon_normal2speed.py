...
model = dict(
            type='asymmetrical_SimSiamRecognizer2D',
            ...
            cls_head=dict(num_segments=clip_len,
                        ...
                        in_channels=2048,
                        dropout_ratio=0.0),
            projectionMLP=dict(type='projection_MLP_avg',
                                num_segments=clip_len,
                                feature_size=2048),
            predictionMLP = dict(type='prediction_MLP',
                                feature_size=2048),
            contrastive_loss=dict(type='supervisedContrastiveLoss',
                                name='speed',temperature=0.8,type_loss='contrastive'))
