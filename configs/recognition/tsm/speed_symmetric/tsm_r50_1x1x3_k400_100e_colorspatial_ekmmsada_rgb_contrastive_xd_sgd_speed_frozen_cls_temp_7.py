...
model = dict(
            ...
            predictionMLP = dict(type='prediction_MLP',
                                feature_size=2048),
            contrastive_loss=dict(type='Symmetric_ContrastiveLossv2', name='speed',
                                use_positives_in_denominator=True,temperature=7.0,
                              ))
...
# optimizer
optimizer = dict(
    lr=0.0075 * (24 / 8) * (4 / 8),  # this lr is used for 8 gpus
)
