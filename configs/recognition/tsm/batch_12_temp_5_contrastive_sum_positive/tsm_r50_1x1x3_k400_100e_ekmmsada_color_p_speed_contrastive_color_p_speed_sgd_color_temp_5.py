...
model = dict(
            ...
            predictionMLP = dict(type='prediction_MLP',
                                feature_size=2048),
            contrastive_loss=dict(type='SingleInstanceContrastiveLossv2_sum_positive',
...
train_dataset_type = 'hmdb_ucf_split'
val_dataset_type = 'RawframeDataset'
img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_bgr=False)
pathway_A_pipeline = [ #normal
