#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J reproduce_3m
#SBATCH -o /data/shinpaul14/outputs/reproduce_3m.out
#SBATCH -e /data/shinpaul14/outputs/reproduce_3m.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -w ariel-v12
...
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/sup_con/tsm_r50_1x1x3_100e_ekmmsada_SupCon_normal2speed.py"
