...
#/data/jongmin/projects/mmaction2_paul_work/work_dirs/tsm_r50_1x1x3_100e_ekmmsada_rgb_simsiam_V1_check/tsm-k400-color-simsiam_neg_cos_loss_sgd_color

work_dir="/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name"


d1_ckpt="/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name/train_D1_test_D1/best_top1_acc_epoch_45.pth"


# d2_ckpt="/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name/train_D2_test_D2/best_top1_acc_epoch_5.pth"


# d3_ckpt="/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name/train_D3_test_D3/best_top1_acc_epoch_35.pth"
