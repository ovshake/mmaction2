#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_5_sum_row
...
# #--------------------------------------------------
exp_name="tsm-k400-speed-contrastive_normal_sgd_speed_temp_5_row"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_ablation_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/speed_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_contrastive_sgd_speed_temp_5_row.py"
...
exp_name1="tsm-k400-speed-contrastive_normal_sgd_speed_temp_5_row"
