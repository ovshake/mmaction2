...
#SBATCH -o /data/shinpaul14/outputs/train_speed_contrastive_6.out
#SBATCH -e /data/shinpaul14/outputs/train_speed_contrastive_6.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/speed_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_6.py"
...
# #/data/shinpaul14/projects/mmaction2/work_dirs/tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_contrastive_V1/tsm-k400-speed-contrastive_xd_sgd_speed_temp_8/train_D1_test_D1/latest.pth
