...
#SBATCH -o /data/shinpaul14/outputs/train_speed_simsiam_contrastive_7.out
#SBATCH -e /data/shinpaul14/outputs/train_speed_simsiam_contrastive_7.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai7
...
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/speed_symmetric/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_7.py"
