#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_normal_sgd_color_p_speed
...
#--------------------------------------------------
exp_name="tsm-k400-color-contrastive_normal_sgd_color_p_speed"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_08_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_08_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_color_p_speed_contrastive_normal_sgd_color_p_speed_frozen_cls_temp_08.py"
...
exp_name1="tsm-k400-color-contrastive_normal_sgd_color_p_speed"
