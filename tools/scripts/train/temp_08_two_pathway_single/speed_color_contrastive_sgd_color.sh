#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_color_contrastive_sgd_color
#SBATCH -o /data/shinpaul14/outputs/train_speed_color_contrastive_sgd_color.out
#SBATCH -e /data/shinpaul14/outputs/train_speed_color_contrastive_sgd_color.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -w ai8
...
#--------------------------------------------------
exp_name="tsm-k400-speed-color-contrastive_speed_sgd_color"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_08_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/temp_08_two_pathway_single/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_color_speed_contrastive_xd_sgd_color_frozen_cls_temp_08.py"
...
exp_name1="tsm-k400-speed-color-contrastive_speed_sgd_color"
