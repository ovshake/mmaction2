#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_sgd_color_cls
...
#--------------------------------------------------
# exp_name="tsm-k400-color-contrastive_normal_sgd_color"
...
exp_name1="tsm-k400-color-contrastive_normal_sgd_color"
