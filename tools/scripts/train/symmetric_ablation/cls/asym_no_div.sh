#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_color_contrastive_sgd_color_asymmetric_cls
#SBATCH -o /data/shinpaul14/outputs/train_both_color_contrastive_sgd_color_asymmetric.out
#SBATCH -e /data/shinpaul14/outputs/train_both_color_contrastive_sgd_color_asymmetric.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
#--------------------------------------------------
# exp_name="tsm-k400-color-contrastive_sgd_color_asymmetric"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_symmetric_ablation"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/symmetric_ablation/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_5_asymmetric.py'
...
exp_name1="tsm-k400-color-contrastive_sgd_color_asymmetric"
