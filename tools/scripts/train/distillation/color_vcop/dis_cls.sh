#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distill_color_vcop_cls
#SBATCH -o /data/shinpaul14/outputs/train_distill_d1.out
#SBATCH -e /data/shinpaul14/outputs/train_distill_d1.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
#--------------------------------------------------
# exp_name="tsm-k400-color-contrastive_xd_sgd_color_speed_fusion_cls"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_speed_late_fusion"
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_speed_color_input_normal_cls.py"
# exp_name="tsm-k400-color-contrastive_xd_sgd_color_vcop_distill"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_distillation"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/distillation/tsm_r50_1x1x3_100e_ekmmsada_distillation_rgb_color_vcop.py'
...
exp_name1="tsm-k400-color-contrastive_xd_sgd_color_vcop_distill_norm"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_distillation"
...
exp_name="tsm-k400-color-contrastive_xd_sgd_color_vcop_distill_norm"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_distillation_cls"
