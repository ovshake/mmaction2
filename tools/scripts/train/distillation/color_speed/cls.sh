#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distill_color_speed_d1
...
# exp_name="tsm-k400-color-contrastive_xd_sgd_color_speed_distill_norm"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_distillation"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/distillation/tsm_r50_1x1x3_100e_ekmmsada_distillation_rgb_color_speed.py'
...
exp_name1="tsm-k400-color-contrastive_xd_sgd_color_speed_distill_norm"
