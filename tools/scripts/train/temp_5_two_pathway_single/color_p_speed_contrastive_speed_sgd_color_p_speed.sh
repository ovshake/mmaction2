#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_speed_sgd_color_p_speed_check
...
#--------------------------------------------------
exp_name="tsm-k400-color-p-speed-contrastive_speed_sgd_color_p_speed_check"
...
exp_name1="tsm-k400-color-p-speed-contrastive_speed_sgd_color_p_speed_check"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_5_V1"
