#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_color_sgd_color_p_speed_check
#SBATCH -o /data/shinpaul14/outputs/train_color_p_speed_contrastive_color_sgd_color_p_speed.out
#SBATCH -e /data/shinpaul14/outputs/train_color_p_speed_contrastive_color_sgd_color_p_speed.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
#--------------------------------------------------
exp_name="tsm-k400-color-p-speed-contrastive_color_sgd_color_p_speed_check"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_5_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_both_color_p_speed_contrastive_color_sgd_color_p_speed_frozen_cls_temp_5.py"
...
exp_name1="tsm-k400-color-p-speed-contrastive_color_sgd_color_p_speed_check"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_5_V1"
...
exp_name="tsm-k400-color-p-speed-contrastive_color_sgd_color_p_speed_check"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_5_V2_cls"
