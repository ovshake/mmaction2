#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_sgd_speed_check
...
#--------------------------------------------------
exp_name="tsm-k400-color-p-speed-contrastive_sgd_speed_check"
...
exp_name1="tsm-k400-color-p-speed-contrastive_sgd_speed_check"
