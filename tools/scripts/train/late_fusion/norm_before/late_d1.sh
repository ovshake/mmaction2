...
#SBATCH -o /data/shinpaul14/outputs/train_late_fusion_d1.out
#SBATCH -e /data/shinpaul14/outputs/train_late_fusion_d1.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_speed_late_fusion"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_speed_color_vcop_input_normal_cls_before.py'
