#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_late_fusion_d3
#SBATCH -o /data/shinpaul14/outputs/train_late_fusion_d3.out
#SBATCH -e /data/shinpaul14/outputs/train_late_fusion_d3.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_speed_color_input_normal_end.py"
exp_name="tsm-k400-color-contrastive_xd_sgd_color_vcop_fusion"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_speed_late_fusion"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_vcop_color_input_normal_cls.py'
