#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_late_fusion_all_cls_e200
...
exp_name="tsm-k400-color-contrastive_xd_sgd_fusion_norm_after_color_speed_vcop_e200"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_speed_late_fusion"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_speed_color_vcop_concat.py'
