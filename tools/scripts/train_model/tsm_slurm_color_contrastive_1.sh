...
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/simsiam_NO_CLS/tsm_r50_1x1x3_100e_colorspatial_ekmmsada_rgb_real_simsiam_xdb_sgd_color_frozen_cls_all_vid.py"
