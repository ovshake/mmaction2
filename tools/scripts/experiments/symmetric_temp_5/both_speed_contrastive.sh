#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_speed_contrastive_symmetric
...
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_symmetric/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_both_speed_contrastive_speed_speed_temp_5.py'
