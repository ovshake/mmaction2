#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_CS_VCOP_d1_cls
...
#--------------------------------------------------
# exp_name="tsm_k400_distillation_CS_VCOP"
# exp_section="ICMR_distil_final_new_cls"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_distil/tsm_r50_1x1x3_100e_ekmmsada_distillation_CS_vcop.py'
...
exp_name1="tsm_k400_distillation_CS_VCOP_each"
