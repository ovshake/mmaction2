#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_speed_pathway_temp_5_batch_12
...
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_12_temp_5_contrastive/tsm_r50_1x1x3_k400_100e_ekmmsada_both_speed_contrastive_temp_5.py'
...
exp_name1="tsm-k400-both-speed_pathway"
