#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_normal_color_pathway_temp_5_batch_12_ablation
...
#--------------------------------------------------
exp_name="tsm-k400-normal_color_pathway_ablation"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_temp_5_batch_12_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_12_temp_5_contrastive/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_normal_sgd_color_temp_5_ablation.py'
