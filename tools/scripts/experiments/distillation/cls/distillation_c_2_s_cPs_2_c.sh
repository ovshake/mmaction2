#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_C_2_S_&_CPS_2_C_cls
...
#--------------------------------------------------
# exp_name="tsm-k400-distillation_Color_2_Speed_&_ColorPSpeed_2_Color"
...
exp_name1="tsm-k400-distillation_Color_2_Speed_&_ColorPSpeed_2_Color_wo_norm"
...
exp_name="tsm-k400-distillation_Color_2_Speed_&_ColorPSpeed_2_Color_wo_norm"
