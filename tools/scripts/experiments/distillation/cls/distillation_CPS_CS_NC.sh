#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_CPS_CS_NC_cls
#SBATCH -o ./out/train_distil_CPS_CS_NC_cls.out
#SBATCH -e ./out/train_distil_CPS_CS_NC_cls.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -w ai11
...
exp_nam1e="tsm_k400_distillation_CPS_CS_NC"
