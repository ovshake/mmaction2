#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_CPS_NC
#SBATCH -o /data/shinpaul14/outputs/train_distil_CPS_NC.out
#SBATCH -e /data/shinpaul14/outputs/train_distil_CPS_CS.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -w ai11
...
#--------------------------------------------------
exp_name="tsm-k400-distillation_CPS_NC"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_distillation_batch_12_V1_ICMR"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_12_distillation/tsm_r50_1x1x3_100e_ekmmsada_distillation_CPS_NC.py'
