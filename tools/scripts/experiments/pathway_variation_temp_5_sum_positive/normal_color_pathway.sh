#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_normal_color_pathway_temp_5_batch_12_sum_positive
...
exp_section="tsm_r50_1x1x3_100e_ekmmsada_sum_positive_temp_5_batch_12_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_12_temp_5_contrastive_sum_positive/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_normal_sgd_color_temp_5.py'
