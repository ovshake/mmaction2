#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_normal_speed_pathway_temp_5_cls
...
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_ekmmsada_speed_contrastive_normal_sgd_speed_temp_5.py'
