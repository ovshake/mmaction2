#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_7
#SBATCH -o ./out/train_color_contrastive_temp_7.out
#SBATCH -e ./out/train_color_contrastive_temp_7.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai3
...
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_contrastive_ablation/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_7.py'
