#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_5_cls
...
#--------------------------------------------------
# exp_name="tsm_k400_color_contrastive_normal_sgd_color_temp_5"
...
exp_name1="tsm_k400_color_contrastive_normal_sgd_color_temp_5"
