#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_7_cls
#SBATCH -o /data/shinpaul14/outputs/train_color_contrastive_temp_1.out
#SBATCH -e /data/shinpaul14/outputs/train_color_contrastive_temp_1.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
# #--------------------------------------------------
# exp_name="tsm_k400_color_contrastive_normal_sgd_color_temp_7"
...
exp_name1="tsm_k400_color_contrastive_normal_sgd_color_temp_7"
