#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J EK_CLIP_D1_center_frame
#SBATCH -o ./out/D1.out
#SBATCH -e ./out/D1.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
...
PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D1_test_D1 data.train.domain='D1' data.val.domain='D1' model.clip_method='center' total_epochs=100  --validate --deterministic
