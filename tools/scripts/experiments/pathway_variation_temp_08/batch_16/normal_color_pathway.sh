#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_normal_color_pathway_temp_08_batch_16
...
exp_section="tsm_r50_1x1x3_100e_ekmmsada_temp_08_batch_16_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_16_temp_08_contrastive/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_normal_sgd_color_temp_08.py'
