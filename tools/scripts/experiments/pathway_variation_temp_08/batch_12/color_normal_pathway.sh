#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_normal_pathway_temp_5_batch_12_cls
...
#--------------------------------------------------
# exp_name="tsm-k400-color_normal_pathway"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_temp_5_batch_12_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_12_temp_5_contrastive/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_color_sgd_normal_temp_5.py'
...
exp_name1="tsm-k400-color_normal_pathway"
