...
#--------------------------------------------------
exp_name="tsm_k400_CPS_vcop_all"
exp_section="ICMR_late_fusion_clip_all"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_ensemble_clip/tsm_r50_1x1x3_100e_latefusion_CPS_vcop_concat.py'
