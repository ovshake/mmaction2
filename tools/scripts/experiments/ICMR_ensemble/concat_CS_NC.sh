#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J tsm_k400_CS_NC
#SBATCH -o ./out/tsm_k400_CS_NC.out
#SBATCH -e ./out/tsm_k400_CS_NC.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai1
...
#--------------------------------------------------
exp_name="tsm_k400_CS_NC"
exp_section="ICMR_late_fusion"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_ensemble/tsm_r50_1x1x3_100e_latefusion_NC_CS_concat.py'
