#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J tsm_k400_CPS_CS_VCOP_NC_D3
...
#--------------------------------------------------
exp_name="tsm_k400_CPS_CS_vcop_NC"
exp_section="ICMR_late_fusion"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_ensemble/tsm_r50_1x1x3_100e_latefusion_CPS_CS_concat_vcop_NC.py'
