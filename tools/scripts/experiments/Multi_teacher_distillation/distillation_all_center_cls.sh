#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J multi_teacher_distillation_dim_reduction_center_cls
...
#--------------------------------------------------
# exp_name="tsm_k400_multi_teacher_distillation_dim_reduce_all_clip_center_frames"
...
exp_name1="tsm_k400_multi_teacher_distillation_dim_reduce_all_clip_center_frames"
