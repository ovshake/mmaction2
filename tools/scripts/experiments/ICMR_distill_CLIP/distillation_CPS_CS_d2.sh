#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_CPS_CS_d2
...
#--------------------------------------------------
exp_name="tsm_k400_distillation_CPS_CS"
exp_section="ICMR_distil_final_clip"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_distil_clip/tsm_r50_1x1x3_100e_ekmmsada_distillation_CPS_CS.py'
