#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_CPS__vcop_d2
...
#--------------------------------------------------
exp_name="tsm_k400_distillation_CPS_vcop_each"
exp_section="ICMR_distil_final_clip"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_distil_clip/tsm_r50_1x1x3_100e_ekmmsada_distillation_CPS_vcop.py'
...
PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D2_test_D2 data.train.domain='D2' data.val.domain='D2' model.domain='D2' model.clip_method='all'   total_epochs=100  --validate --deterministic
