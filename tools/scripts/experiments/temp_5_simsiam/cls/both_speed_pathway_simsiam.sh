#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_speed_simsiam
#SBATCH -o /data/shinpaul14/outputs/train_both_speed_simsiam.out
#SBATCH -e /data/shinpaul14/outputs/train_both_speed_simsiam.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
#--------------------------------------------------
exp_name="tsm-k400-both-speed-simsiam"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_simsiam_5_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_simsiam/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_both_speed_contrastive_speed_speed.py"
...
exp_name1="tsm-k400-both-speed-simsiam"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_simsiam_5_V1"
...
exp_name="tsm-k400-both-speed-simsiam"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_simsiam_5_V2_cls"
