#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_08
#SBATCH -o ./out/train_color_contrastive_temp_q.out
#SBATCH -e ./out/train_color_contrastive_temp_q.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai9
...
#--------------------------------------------------
exp_name="tsm_k400_color_contrastive_normal_sgd_color_temp_08"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_ablation_batch_16_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_16_normal_color/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_normal_sgd_color_temp_08.py'
...
exp_name1="tsm_k400_color_contrastive_normal_sgd_color_temp_08"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_color_ablation_batch_16_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_train_cls_batch_16.py'
exp_name="tsm_k400_color_contrastive_normal_sgd_color_temp_08"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_ablation_batch_16_V2_cls"
