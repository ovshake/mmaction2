#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_temp_08_cls
#SBATCH -o /data/shinpaul14/outputs/train_color_p_speed_contrastive.out
#SBATCH -e /data/shinpaul14/outputs/train_color_p_speed_contrastive.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai11
...
#--------------------------------------------------
exp_name="tsm_k400_color_p_speed_contrastive_cps_sgd_normal_temp_007"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_p_speed_contrastive_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_p_speed_contrastive_ablation/tsm_r50_1x1x3_k400_100e_ekmmsada_color_p_speed_contrastive_cps_sgd_color_frozen_cls_temp_007.py'
...
# exp_name1="tsm_k400_color_p_speed_contrastive_cps_sgd_normal_temp_007"
# exp_section1="tsm_r50_1x1x3_100e_ekmmsada_color_p_speed_contrastive_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_train_cls.py'
# exp_name="tsm_k400_color_p_speed_contrastive_cps_sgd_normal_temp_007"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_p_speed_contrastive_V2_cls"
