#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_temp_4_cls
...
#--------------------------------------------------
exp_name="tsm_k400_color_p_speed_contrastive_cps_sgd_normal_temp_4"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_p_speed_contrastive_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_p_speed_contrastive_ablation/tsm_r50_1x1x3_k400_100e_ekmmsada_color_p_speed_contrastive_cps_sgd_color_frozen_cls_temp_4.py'
...
# exp_name1="tsm_k400_color_p_speed_contrastive_cps_sgd_normal_temp_4"
