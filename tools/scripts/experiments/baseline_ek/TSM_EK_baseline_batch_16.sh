#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_tsm_baseline_total_batch_64
#SBATCH -o ./out/train_tsm_baseline_total_batch_64.out
#SBATCH -e ./out/train_tsm_baseline_total_batch_64.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai8
...
#--------------------------------------------------
exp_name="tsm_k400_100e_ekmmsada_dg_baseline_batch_16"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_baseline"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_baseline_batch_16.py"
