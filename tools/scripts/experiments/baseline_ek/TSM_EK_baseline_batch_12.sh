#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_tsm_baseline_total_batch_48sdsdsds
#SBATCH -o ./out/train_tsm_baseline_total_batch_48.out
#SBATCH -e ./out/train_tsm_baseline_total_batch_48.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai9
...
#--------------------------------------------------
# exp_name="tsm_k400_100e_ekmmsada_dg_baseline_batch_12"
