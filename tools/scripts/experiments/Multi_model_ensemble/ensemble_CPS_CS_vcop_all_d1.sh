#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J multi_model_emsemble_all_d1
...
#--------------------------------------------------
exp_name="tsm_k400_multi_model_ensemble_dim_reduce_all_clip_all_frames"
