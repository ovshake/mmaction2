#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J multi_model_emsemble_center_d3
...
#--------------------------------------------------
exp_name="tsm_k400_multi_model_ensemble_dim_reduce_all_clip_center_frames"
exp_section="Multi_model_ensemble"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_ensemble_clip/tsm_r50_1x1x3_100e_latefusion_CPS_CS_concat_vcop_dim_reduction.py'
PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D3_test_D3 data.train.domain='D3' data.val.domain='D3' model.domain='D3' model.clip_method='center' model.reduction=True total_epochs=100  --validate --deterministic
