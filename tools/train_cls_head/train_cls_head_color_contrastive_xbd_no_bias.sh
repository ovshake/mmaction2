#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J CLS_head_200epochs
#SBATCH -o /data/shinpaul14/outputs/CLS_head_200epochs.out
#SBATCH -e /data/shinpaul14/outputs/CLS_head_200epochs.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
exp_name1="tsm-k400-color-contrastive-xbd-color-sgd_no_bias_w_kinetic"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_v1"

exp_name="tsm-k400-color-contrastive_xdb_sgd_color_no_bias_kinetics_200epoch"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_contrstive_v2"
