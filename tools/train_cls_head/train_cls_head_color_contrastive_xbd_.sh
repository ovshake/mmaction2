#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J CLS_head_no_dropout
#SBATCH -o /data/shinpaul14/outputs/CLS_head_no_dropout.out
#SBATCH -e /data/shinpaul14/outputs/CLS_head_no_dropout.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
exp_name1="tsm-k400-color-contrastive-xbd-color-sgd"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_v1"

exp_name="tsm-k400-color-contrastive_xdb_sgd_color_no_dropout"
