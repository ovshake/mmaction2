#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J CLS_head_100epochs
#SBATCH -o /data/shinpaul14/outputs/CLS_head_100epochs.out
#SBATCH -e /data/shinpaul14/outputs/CLS_head_100epochs.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
exp_name1="tsm-k400-color-simsiam_xdb_sgd_color_freeze_constructor"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_simsiam_scratch"

exp_name="tsm-k400-color-simsiam_xdb_sgd_color_freeze_constructor_finetune_clshead_best_epoch"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_simsiam_scratch_stage2"
