...
#SBATCH -o /data/shinpaul14/outputs/train_self_contrastive_Previous_frame_sampling.out
#SBATCH -e /data/shinpaul14/outputs/train_self_contrastive_Previous_frame_sampling.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
