...
#SBATCH -o /data/shinpaul14/outputs/multi_contrastive_xabd_keys_sgd_cls.out
#SBATCH -e /data/shinpaul14/outputs/multi_contrastive_xabd_keys_sgd_cls.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[10]
...
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_multi_contrastive_v2"
# PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D1_test_D1 data.train.domain='D1' data.val.domain='D1' load_from="/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section1/$exp_name1/train_D1_test_D1/best_top1_acc_epoch_15.pth" total_epochs=100  --validate --deterministic

# PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D2_test_D2 data.train.domain='D2' data.val.domain='D2' load_from="/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section1/$exp_name1/train_D2_test_D2/best_top1_acc_epoch_90.pth" total_epochs=100  --validate --deterministic
