#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_color_p_speed_contrastive_symmetric_cls
...
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_two_pathway_symmetric_5_V1"
...
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_two_pathway_symmetric_5_V1"
