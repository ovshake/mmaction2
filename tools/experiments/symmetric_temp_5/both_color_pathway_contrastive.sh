#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_color_contrastive_symmetric
...
#--------------------------------------------------
exp_name="tsm-k400-both-color-contrastive"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_symmetric_5_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_symmetric/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_both_color_contrastive_sgd_color_frozen_cls_temp_5.py'
