#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_normal_color_pathway_temp_5_cls
...
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_normal_sgd_color_temp_5.py'
...
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_sum_positive_temp_5_batch_12_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_train_cls.py'
exp_name="tsm-k400-normal_color_pathway"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_sum_positive_temp_5_batch_12_V2_cls"
