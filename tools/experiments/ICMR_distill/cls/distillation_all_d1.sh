#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_all_d1_cls
...
#--------------------------------------------------
# exp_name="tsm_k400_distillation_all"
# exp_section="ICMR_distil_final_new"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_distil/tsm_r50_1x1x3_100e_ekmmsada_distillation_CPS_CS_vcop_all.py'
...
exp_name1="tsm_k400_distillation_all_each"
exp_section1="ICMR_distil_final_new"
...
exp_section="ICMR_distil_final_new_cls"
