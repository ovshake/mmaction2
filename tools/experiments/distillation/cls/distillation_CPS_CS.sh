#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distil_CPS_CS_cls
#SBATCH -o /data/shinpaul14/outputs/train_distil_CPS_CS_cls.out
#SBATCH -e /data/shinpaul14/outputs/train_distil_CPS_CS_cls.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -w ai9
...
exp_name1="tsm-k400-distillation_CPS_CS"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_distillation_batch_12_V1_ICMR"
...
exp_name="tsm-k400-distillation_CPS_CS"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_distillation_batch_12_V1_ICMR_cls"
