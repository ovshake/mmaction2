#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_vcop_3_batch_16_cls
#SBATCH -o /data/shinpaul14/outputs/train_vcop.out
#SBATCH -e /data/shinpaul14/outputs/train_vcop.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai7
...
#--------------------------------------------------
# exp_name="tsm-k400-vcop_clip3"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_vcop"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/VCOP/tsm_r50_1x1x3_100e_ekmmsada_vcop_rgb_frozen_cls_v_3.py'
...
exp_name1="tsm-k400-vcop_clip3"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_vcop"
...
exp_name="tsm-k400-vcop_clip3_batch_16_cls"
