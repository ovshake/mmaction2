#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_vcop_6_cls_batch_16_cls
...
#--------------------------------------------------
# exp_name="tsm-k400-vcop_clip6"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_vcop"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/VCOP/tsm_r50_1x1x3_100e_ekmmsada_vcop_rgb_frozen_cls.py'
...
exp_name="tsm-k400-vcop_clip6_batch_16_cls"
