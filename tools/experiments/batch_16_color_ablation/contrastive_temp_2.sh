#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_2
...
#--------------------------------------------------
exp_name="tsm_k400_color_contrastive_normal_sgd_color_temp_2"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_ablation_batch_16_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_16_normal_color/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_normal_sgd_color_temp_2.py'
...
exp_name1="tsm_k400_color_contrastive_normal_sgd_color_temp_2"
