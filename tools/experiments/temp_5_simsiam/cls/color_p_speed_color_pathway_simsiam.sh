#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_color_p_speed_color_simsiam_cls
...
#--------------------------------------------------
# exp_name="tsm-k400-both-color_p_speed-color-simsiam"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_simsiam_5_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_simsiam/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_both_color_p_speed_contrastive_color_color_p_speed.py'
...
exp_name1="tsm-k400-both-color_p_speed-color-simsiam"
