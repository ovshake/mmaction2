#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_temp_007_cls
#SBATCH -o /data/shinpaul14/outputs/train_speed_contrastive_temp.out
#SBATCH -e /data/shinpaul14/outputs/train_speed_contrastive_temp.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
#--------------------------------------------------
# exp_name="tsm_k400_speed_contrastive_normal_sgd_speed_temp_007"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_speed_contrastive_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/speed_contrastive_ablation/tsm_r50_1x1x3_k400_100e_ekmmsada_speed_contrastive_normal_sgd_speed_temp_007.py'
...
exp_name1="tsm_k400_speed_contrastive_normal_sgd_speed_temp_007"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_speed_contrastive_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_train_cls.py'
exp_name="tsm_k400_speed_contrastive_normal_sgd_speed_temp_007"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_speed_contrastive_V2_cls"
