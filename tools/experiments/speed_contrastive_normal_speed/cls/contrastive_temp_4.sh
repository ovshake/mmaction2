#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_temp_4
...
#--------------------------------------------------
exp_name="tsm_k400_speed_contrastive_normal_sgd_speed_temp_4"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_speed_contrastive_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/speed_contrastive_ablation/tsm_r50_1x1x3_k400_100e_ekmmsada_speed_contrastive_normal_sgd_speed_temp_4.py'
...
# exp_name1="tsm_k400_speed_contrastive_normal_sgd_speed_temp_4"
