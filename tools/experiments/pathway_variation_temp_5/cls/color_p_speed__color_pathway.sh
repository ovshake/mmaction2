#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_color_pathway_temp_5_cls
...
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_ekmmsada_color_p_speed_contrastive_color_p_speed_sgd_color_temp_5.py'
...
exp_name1="tsm-k400-color_p_speed_color_pathway"
