#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J multi_teacher_distillation_random_d2
...
#--------------------------------------------------
# exp_name="tsm_k400_multi_teacher_distillation_random_model_all_clip_all_frames"
...
exp_name1="tsm_k400_multi_teacher_distillation_random_model_all_clip_all_frames"
