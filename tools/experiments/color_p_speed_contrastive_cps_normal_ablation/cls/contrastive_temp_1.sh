#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_temp_1_cls
#SBATCH -o ./out/train_color_contrastive_temp_sdsd2.out
#SBATCH -e ./out/train_color_contrastive_temp_sds2.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai1
...
# #--------------------------------------------------
# exp_name="tsm_k400_color_p_speed_contrastive_cps_sgd_normal_temp_1"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_p_speed_contrastive_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_p_speed_contrastive_ablation/tsm_r50_1x1x3_k400_100e_ekmmsada_color_p_speed_contrastive_cps_sgd_color_frozen_cls_temp_1.py'
...
exp_name1="tsm_k400_color_p_speed_contrastive_cps_sgd_normal_temp_1"
