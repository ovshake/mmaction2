#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J CLIP_distillation_all_frame_d2
#SBATCH -o ./out/CLIP_distillation_all_frame_d2.out
#SBATCH -e ./out/CLIP_distillation_all_frame_d2.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -w ariel-v3
