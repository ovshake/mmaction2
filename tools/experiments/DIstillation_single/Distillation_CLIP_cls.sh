#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J CLIP_distillation_all_frame_cls
...
exp_name1="tsm_k400_distillation_CLIP_all_frame"
exp_section1="Single_Distillation"
...
exp_name="tsm_k400_distillation_CLIP_all_frame"
exp_section="Single_Distillation_cls"
