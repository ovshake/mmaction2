#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J Speed_contrastive_extra_positive_cls
...
#--------------------------------------------------
# exp_name="tsm_k400_normal_2_speed_pathway_added_positive"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_Debug_v1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single_extra_positve_added/tsm_r50_1x1x3_k400_100e_ekmmsada_speed_contrastive_normal_sgd_speed_temp_5.py'
...
exp_name1="tsm_k400_normal_2_speed_pathway_added_positive"
