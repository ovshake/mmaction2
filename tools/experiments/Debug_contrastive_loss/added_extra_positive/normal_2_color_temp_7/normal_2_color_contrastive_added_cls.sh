#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J Color_contrastive_extra_positive_cls
...
#--------------------------------------------------
# exp_name="tsm_k400_normal_2_color_pathway_added_positive_temp_7"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_Debug_v1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single_extra_positve_added/tsm_r50_1x1x3_k400_100e_ekmmsada_color_contrastive_normal_sgd_color_temp_5.py'



# PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D1_test_D1 data.train.domain='D1' data.val.domain='D1' model.contrastive_loss.temperature=7.0 total_epochs=100  --validate --deterministic

# PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D2_test_D2 data.train.domain='D2' data.val.domain='D2' model.contrastive_loss.temperature=7.0 total_epochs=100  --validate --deterministic

# PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D3_test_D3 data.train.domain='D3' data.val.domain='D3' model.contrastive_loss.temperature=7.0 total_epochs=100  --validate --deterministic


exp_name1="tsm_k400_normal_2_color_pathway_added_positive_temp_7"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_Debug_v1"
...
exp_name="tsm_k400_normal_2_color_pathway_added_positive_temp_7"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_Debug_v2_cls"
