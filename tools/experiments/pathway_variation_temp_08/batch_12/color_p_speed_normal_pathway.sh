#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_normal_pathway_temp_5_batch_12
...
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_12_temp_5_contrastive/tsm_r50_1x1x3_k400_100e_ekmmsada_color_p_speed_contrastive_color_p_speed_sgd_normal_temp_5.py'
