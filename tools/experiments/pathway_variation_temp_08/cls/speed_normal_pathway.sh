#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_normal_pathway_temp_5_cls
...
#--------------------------------------------------
# exp_name="tsm-k400-speed_normal_pathway"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_temp_5_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_ekmmsada_speed_contrastive_speed_sgd_normal_temp_5.py'
...
exp_name1="tsm-k400-speed_normal_pathway"
