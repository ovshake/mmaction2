#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_concat_vcop_cps_2_c_normalize
#SBATCH -o ./out/train_concat_all.out
#SBATCH -e ./out/train_concat_all.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai11
...
#--------------------------------------------------
exp_name="tsm_k400_concat_vcop_cps_sgd_c_normalize"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_late_fusion_normalize"
