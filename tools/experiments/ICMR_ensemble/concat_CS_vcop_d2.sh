...
#--------------------------------------------------
exp_name="tsm_k400_CS_vcop"
exp_section="ICMR_late_fusion"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/ICMR_ensemble/tsm_r50_1x1x3_100e_latefusion_CS_vcop_concat.py'
