#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_plus_speed_to_color_contrastive_temp_08
...
#--------------------------------------------------
exp_name="tsm_k400_CPS_contrastive_CPS_sgd_color_temp_08"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_plus_speed_contrastive_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/batch_12_color_p_speed_temp_ablation/tsm_r50_1x1x3_k400_100e_ekmmsada_color_p_speed_contrastive_color_p_speed_sgd_color_temp_08.py'
