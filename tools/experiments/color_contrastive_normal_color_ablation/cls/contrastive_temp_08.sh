#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_08_cls
#SBATCH -o /data/shinpaul14/outputs/train_color_contrastive_temp_05.out
#SBATCH -e /data/shinpaul14/outputs/train_color_contrastive_temp_05.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai1
...
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_08.py'
