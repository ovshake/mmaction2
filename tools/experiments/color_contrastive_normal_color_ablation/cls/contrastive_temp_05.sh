#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_05_cls
...
#--------------------------------------------------
# exp_name="tsm_k400_color_contrastive_normal_sgd_color_temp_05"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_color_contrastive_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_05.py'
...
exp_name1="tsm_k400_color_contrastive_normal_sgd_color_temp_05"
