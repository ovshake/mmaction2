#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_color_p_speed_normal_contrastive_symmetric_cls
...
#--------------------------------------------------
# exp_name="tsm-k400-both-color_p_speed_normal-contrastive"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_symmetric_5_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_symmetric/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_color_p_speed-contrastive_color_p_speed_normal_temp_5.py'
...
exp_name1="tsm-k400-both-color_p_speed_normal-contrastive"
