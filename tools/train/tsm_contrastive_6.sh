#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_w_dropout
...
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/w_dropout/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xbd_sgd_color_frozen_cls.py"
