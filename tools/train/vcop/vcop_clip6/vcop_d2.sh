#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_vcop_d2
#SBATCH -o /data/jongmin/outputs/train_vcop.out
#SBATCH -e /data/jongmin/outputs/train_vcop.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
config='/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/VCOP/tsm_r50_1x1x3_100e_ekmmsada_vcop_rgb_frozen_cls.py'
