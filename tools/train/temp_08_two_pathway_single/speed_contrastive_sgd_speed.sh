#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_sgd_speed_temp_08
...
#--------------------------------------------------
exp_name="tsm-k400-speed-contrastive_normal_sgd_speed"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_08_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_08_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_speed_contrastive_xd_sgd_speed_frozen_cls_temp_08.py"
...
exp_name1="tsm-k400-speed-contrastive_normal_sgd_speed"
