#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_sgd_speed_cls
...
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_both_color_p_speed_contrastive_sgd_speed_frozen_cls_temp_5.py"
