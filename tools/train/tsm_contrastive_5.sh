...
#SBATCH -o /data/jongmin/outputs/train_speed_2_contrastive.out
#SBATCH -e /data/jongmin/outputs/train_speed_2_contrastive.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_both_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls.py"
