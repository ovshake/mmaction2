#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_normal
#SBATCH -o /data/jongmin/outputs/train_color_contrastive_normal.out
#SBATCH -e /data/jongmin/outputs/train_color_contrastive_normal.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
