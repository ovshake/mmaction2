#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_plus_speed_contrastive_and_normal
...
#--------------------------------------------------
exp_name1="tsm-k400-color_plus_speed-contrastive_xbd_sgd_color_and_speed"
...
exp_name="tsm-k400-color_plus_speed-contrastive_xbd_sgd_color_and_speed"
...
#--------------------------------------------------
exp_name1="tsm-k400-color_plus_speed-contrastive_xbd_sgd_normal"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_V1"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_resfrozen_rgb.py'
exp_name="tsm-k400-color_plus_speed-contrastive_xbd_sgd_normal"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_V2_cls"
...
PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D2_test_D2 data.train.domain='D2' data.val.domain='D2' load_from="./work_dirs/$exp_section1/$exp_name1/train_D2_test_D2/best_top1_acc_epoch_80.pth" total_epochs=100  --validate --deterministic
