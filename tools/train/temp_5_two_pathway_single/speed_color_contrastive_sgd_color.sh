#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_color_contrastive_sgd_color_check
...
#--------------------------------------------------
exp_name="tsm-k400-speed-color-contrastive_speed_sgd_color_check"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_5_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_color_speed_contrastive_xd_sgd_color_frozen_cls_temp_5.py"
...
exp_name1="tsm-k400-speed-color-contrastive_speed_sgd_color_check"
