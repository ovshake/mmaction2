#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_p_speed_contrastive_sgd_normal_check
...
#--------------------------------------------------
exp_name="tsm-k400-color-contrastive_color_p_speed_sgd_normal_check"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_temp_5_V1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_5_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_color_p_speed_contrastive_xd_sgd_normal_frozen_cls_temp_5.py"
...
exp_name1="tsm-k400-color-contrastive_color_p_speed_sgd_normal_check"
