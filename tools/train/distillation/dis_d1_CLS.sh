#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distill__CLS
#SBATCH -o /data/jongmin/outputs/train_distill__CLS.out
#SBATCH -e /data/jongmin/outputs/train_distill__CLS.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
# config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_speed_color_input_normal_cls.py"
# exp_name="tsm-k400-color-contrastive_xd_sgd_color_speed_distill"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_distillation"
# config='/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/distillation/tsm_r50_1x1x3_100e_ekmmsada_distillation_rgb_color_speed.py'
...
exp_name1="tsm-k400-color-contrastive_xd_sgd_color_speed_distill"
