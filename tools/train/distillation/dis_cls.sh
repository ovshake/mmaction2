...
#SBATCH -o /data/jongmin/outputs/train_distill_cls.out
#SBATCH -e /data/jongmin/outputs/train_distill_cls.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
# exp_name="tsm-k400-color-contrastive_xd_sgd_color_speed_vcop_distill"
...
exp_name1="tsm-k400-color-contrastive_xd_sgd_color_speed_vcop_distill"
