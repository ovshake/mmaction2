#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_distill_cls
#SBATCH -o /data/jongmin/outputs/train_distill_d1.out
#SBATCH -e /data/jongmin/outputs/train_distill_d1.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
# exp_name="tsm-k400-color-contrastive_xd_sgd_speed_vcop_distill"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_distillation"
# config='/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/distillation/tsm_r50_1x1x3_100e_ekmmsada_distillation_rgb_speed_vcop.py'
...
exp_name1="tsm-k400-color-contrastive_xd_sgd_speed_vcop_distill"
