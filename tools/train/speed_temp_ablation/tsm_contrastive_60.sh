#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_6
#SBATCH -o /data/jongmin/outputs/train_speed_contrastive_6.out
#SBATCH -e /data/jongmin/outputs/train_speed_contrastive_6.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
# #--------------------------------------------------
# exp_name="tsm-k400-speed-contrastive_xd_sgd_speed_temp_6"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_contrastive_V1"
# config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_6.py"
...
# #/data/jongmin/projects/mmaction2_paul_work/work_dirs/tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_contrastive_V1/tsm-k400-speed-contrastive_xd_sgd_speed_temp_8/train_D1_test_D1/latest.pth

exp_name1="tsm-k400-speed-contrastive_xd_sgd_speed_temp_6"
