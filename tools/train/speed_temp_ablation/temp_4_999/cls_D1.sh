#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_4_999_d1
...
exp_name1="tsm-k400-speed-contrastive_xd_sgd_speed_temp_4_999"
...
exp_name="tsm-k400-speed-contrastive_xd_sgd_speed_temp_4_999"
