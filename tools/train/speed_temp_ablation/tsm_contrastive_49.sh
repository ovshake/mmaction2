#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_49
...
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_4_9.py"
