#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_04
...
# #--------------------------------------------------
exp_name="tsm-k400-speed-contrastive_xd_sgd_speed_temp_04"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_contrastive_V1"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_04.py"
...
exp_name1="tsm-k400-speed-contrastive_xd_sgd_speed_temp_04"
