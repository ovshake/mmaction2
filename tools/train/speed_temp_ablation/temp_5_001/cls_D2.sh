#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_5_001_d2
...
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/speed_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_5_01.py"
...
exp_name1="tsm-k400-speed-contrastive_xd_sgd_speed_temp_5_001"
