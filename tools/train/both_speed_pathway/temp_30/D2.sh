#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_temp_30_d2
#SBATCH -o /data/jongmin/projects/mmaction2_paul_work/train_color_contrastive_temp_50.out
...
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_both_speed_contrastive_V1"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_both_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_30.py"
...
# exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_b23_V1"
