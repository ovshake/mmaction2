...
#SBATCH -o /data/shinpaul14/outputs/train_color_simsiam_cls_d2.out
#SBATCH -e /data/shinpaul14/outputs/train_color_simsiam_cls_d2.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D2_test_D2 data.train.domain='D2' data.val.domain='D2' total_epochs=100  --validate --deterministic
