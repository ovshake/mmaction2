#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_simsiam_D2
#SBATCH -o /data/jongmin/outputs/train_color_simsiam_cls_d2.out
#SBATCH -e /data/jongmin/outputs/train_color_simsiam_cls_d2.err
#SBATCH --time 1-0
#SBATCH -p batch
#SBATCH -w vll1
...
bash /data/jongmin/projects/mmaction2_paul_work/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name/train_D2_test_D2 data.train.domain='D2' data.val.domain='D2' total_epochs=100  --validate --deterministic
