...
#SBATCH -o /data/shinpaul14/outputs/train_speed_color_contrastive_111.out
#SBATCH -e /data/shinpaul14/outputs/train_speed_color_contrastive_111.err
#SBATCH --time 5-0
#SBATCH -p batch_grad
#SBATCH -w ai1
...
#/data/shinpaul14/projects/mmaction2/work_dirs/tsm_r50_1x1x3_100e_ekmmsada_rgb_speed&color_contrastive_V1/tsm-k400-speed-color-contrastive_xd_sgd_speed_color_temp_01
