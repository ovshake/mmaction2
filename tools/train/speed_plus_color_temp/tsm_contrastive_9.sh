#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_color_contrastive_09
...
# config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_plus_color_contrastive_v1/tsm_r50_1x1x3_k400_100e_color_plus_speed_ekmmsada_rgb_contrastive_xd_sgd_color_plus_speed_frozen_cls_temp_09.py"
