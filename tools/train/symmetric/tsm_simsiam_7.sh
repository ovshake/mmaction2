#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_simsiam_contrastive_7
...
#--------------------------------------------------
exp_name="tsm-k400-color-simsiam_contrastive_temp_7_batch24"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_simsiam_V1"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/color_symmetric_contrstive/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_7.py"
...
# exp_name1="tsm-k400-color-simsiam_contrastive_temp_7"
...
# exp_name="tsm-k400-color-simsiam_contrastive_temp_7"
