...
#SBATCH -o /data/shinpaul14/outputs/train_color_contrastive_1.out
#SBATCH -e /data/shinpaul14/outputs/train_color_contrastive_1.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai4
...
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_symmetric_contrstive/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_7.py"
