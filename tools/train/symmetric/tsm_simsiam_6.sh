#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_simsiam_contrastive_5
...
#--------------------------------------------------
exp_name="tsm-k400-color-simsiam_contrastive_temp_5_batch24"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_simsiam_V1"
