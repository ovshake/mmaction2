#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_simsiam_contrastive_7
#SBATCH -o /data/jongmin/outputs/train_speed_simsiam_contrastive_7.out
#SBATCH -e /data/jongmin/outputs/train_speed_simsiam_contrastive_7.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -w ai7
...
#--------------------------------------------------
exp_name="tsm-k400-speed-simsiam_contrastive_temp_7"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_simsiam_V1"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_symmetric/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_7.py"
...
exp_name1="tsm-k400-speed-simsiam_contrastive_temp_7"
