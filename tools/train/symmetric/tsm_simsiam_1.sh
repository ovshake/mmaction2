#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_simsiam_contrastive_08
#SBATCH -o /data/jongmin/outputs/train_color_contrastive_08.out
#SBATCH -e /data/jongmin/outputs/train_color_contrastive_08.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
#--------------------------------------------------
exp_name="tsm-k400-color-simsiam_contrastive_temp_08"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_simsiam_V1"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/color_symmetric_contrstive/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_08.py"
...
exp_name1="tsm-k400-color-simsiam_contrastive_temp_08"
