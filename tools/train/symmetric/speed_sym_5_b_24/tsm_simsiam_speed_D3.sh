...
#SBATCH -o /data/jongmin/outputs/train_speed_simsiam_contrastive_5.out
#SBATCH -e /data/jongmin/outputs/train_speed_simsiam_contrastive_5.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/speed_symmetric/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_5_batch.py"
...
# exp_name1="tsm-k400-speed-simsiam_contrastive_temp_5"
