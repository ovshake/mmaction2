#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_simsiam_contrastive_5_d3
#SBATCH -o /data/shinpaul14/outputs/train_speed_simsiam_contrastive_5.out
#SBATCH -e /data/shinpaul14/outputs/train_speed_simsiam_contrastive_5.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[1,5,10]
...
#--------------------------------------------------
# exp_name="tsm-k400-speed-simsiam_contrastive_temp_5_b24"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_simsiam_V1"
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/speed_symmetric/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_speed_frozen_cls_temp_5_batch.py"
...
exp_name1="tsm-k400-speed-simsiam_contrastive_temp_5_b24"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_simsiam_V1"
...
exp_name="tsm-k400-speed-simsiam_contrastive_temp_5"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_speed_simsiam_V2_cls"
