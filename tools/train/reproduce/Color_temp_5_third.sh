#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_contrastive_temp_5_third
...
#--------------------------------------------------
exp_name="tsm-k400-color-contrastive_xd_sgd_color_temp_5_third"
...
exp_name1="tsm-k400-color-contrastive_xd_sgd_color_temp_5_third"
