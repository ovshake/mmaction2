#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_late_fusion_color_speed_d1
...
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_speed_late_fusion"
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_speed_color_concat.py'
