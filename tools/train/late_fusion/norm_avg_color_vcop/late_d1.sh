#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_late_fusion_color_vcop_avg_d1
...
exp_name="tsm-k400-color-contrastive_xd_sgd_fusion_norm_color_vcop_average"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_speed_late_fusion"
config='/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/late_fusion/tsm_r50_1x1x3_100e_latefusion_color_vcop_avg.py'
