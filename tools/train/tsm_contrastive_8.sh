#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_color_plus_speed_contrastive_V2
...
#--------------------------------------------------
exp_name1="tsm-k400-color-contrastive_xbd_sgd_color_plus_speed"
...
exp_name="tsm-k400-color-contrastive_xbd_sgd_color_plus_speed"
