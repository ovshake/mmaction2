#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_both_color_contrastive_sgd_color_temp_3
...
config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/temp_3_two_pathway_single/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_both_color_contrastive_sgd_color_frozen_cls_temp_3.py'
