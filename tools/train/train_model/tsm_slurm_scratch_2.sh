#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J simsiam_xdb_sgd_color_NO_CLS_freeze_constructor
#SBATCH -o /data/jongmin/outputs/simsiam_xdb_sgd_color_NO_CLS_freeze_constructor.out
#SBATCH -e /data/jongmin/outputs/simsiam_xdb_sgd_color_NO_CLS_freeze_constructor.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
exp_name="tsm-k400-color-simsiam_xdb_sgd_color_NO_CLS_freeze_constructor"
#exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_simsiam_V1"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_simsiam_scratch"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/train_scratch/tsm_r50_1x1x3_100e_colorspatial_ekmmsada_rgb_real_simsiam_xdb_sgd_color_frozen_cls_freeze_constructor.py"
