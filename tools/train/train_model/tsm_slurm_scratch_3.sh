...
#SBATCH -o /data/jongmin/outputs/simsiam_xdb_sgd_color_freeze_constructor.out
#SBATCH -e /data/jongmin/outputs/simsiam_xdb_sgd_color_freeze_constructor.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/simsiam_kinetic/tsm_r50_1x1x3_100e_colorspatial_ekmmsada_rgb_real_simsiam_xdb_sgd_color_freeze_constructor.py"
