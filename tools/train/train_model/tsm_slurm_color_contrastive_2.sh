#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J color_contrastive_xbd_color_sgd
#SBATCH -o /data/jongmin/outputs/color_contrastive_xbd_color_sgd.out
#SBATCH -e /data/jongmin/outputs/color_contrastive_xbd_color_sgd.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
exp_name="tsm-k400-color-contrastive-xbd-color-sgd_no_bias_w_kinetic"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_v1"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/simsiam_NO_CLS/tsm_r50_1x1x3_100e_colorspatial_ekmmsada_rgb_real_simsiam_xdb_sgd_color_frozen_cls_bias_false.py"
