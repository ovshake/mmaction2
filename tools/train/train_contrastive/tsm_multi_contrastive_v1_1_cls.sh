...
#SBATCH -o /data/jongmin/outputs/multi_contrastive_xabd_keys_sgd_div.out
#SBATCH -e /data/jongmin/outputs/multi_contrastive_xabd_keys_sgd_div.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -w ai8
...
#config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/multi_contrastive/multi_contrastive_div.py"
