#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_self_contrastive_Previous_frame_sampling
#SBATCH -o /data/jongmin/outputs/train_self_contrastive_Previous_frame_sampling.out
#SBATCH -e /data/jongmin/outputs/train_self_contrastive_Previous_frame_sampling.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
exp_name="tsm-k400-multi-contrastive-xbd-keys-self_not_same_start"
...
#-----------------
exp_name1="tsm-k400-multi-contrastive-xbd-keys-self_not_same_start"
exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_slef_contrastive_v1"

exp_name="tsm-k400-multi-contrastive-xbd-keys-self_not_same_start_cls_last"
...
# exp_name="tsm-k400-multi-contrastive-xbd-keys-self_not_same_start_cls_best"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_slef_contrastive_v2"
# PORT=7070 bash /data/jongmin/projects/mmaction2_paul_work/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name/train_D1_test_D1 data.train.domain='D1' data.val.domain='D1' load_from="./work_dirs/$exp_section1/$exp_name1/train_D1_test_D1/best_top1_acc_epoch_80.pth" total_epochs=100  --validate --deterministic

# PORT=7070 bash /data/jongmin/projects/mmaction2_paul_work/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name/train_D2_test_D2 data.train.domain='D2' data.val.domain='D2' load_from="./work_dirs/$exp_section1/$exp_name1/train_D2_test_D2/best_top1_acc_epoch_75.pth" total_epochs=100  --validate --deterministic
