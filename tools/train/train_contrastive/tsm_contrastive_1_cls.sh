...
#SBATCH -o /data/jongmin/outputs/contrastive_xd_sgd_color.out
#SBATCH -e /data/jongmin/outputs/contrastive_xd_sgd_color.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
PORT=7070 bash /data/jongmin/projects/mmaction2_paul_work/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/jongmin/projects/mmaction2_paul_work/work_dirs/$exp_section/$exp_name/train_D1_test_D1 data.train.domain='D1' data.val.domain='D1' load_from="./work_dirs/$exp_section1/$exp_name1/train_D1_test_D1/best_top1_acc_epoch_60.pth" total_epochs=100  --validate --deterministic
