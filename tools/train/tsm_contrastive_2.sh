...
#SBATCH -o /data/jongmin/outputs/train_speed_contrastive_normal.out
#SBATCH -e /data/jongmin/outputs/train_speed_contrastive_normal.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
# config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/self/tsm_r50_1x1x3_k400_100e_ekmmsada_rgb_contrastive_xbd_sgd_normal_frozen_cls_no_same_start.py"
...
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V1"
# config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/self/tsm_r50_1x1x3_k400_100e_ekmmsada_rgb_contrastive_xbd_sgd_normal_frozen_cls_same_start.py"
