#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J train_speed_contrastive_normal
#SBATCH -o /data/shinpaul14/outputs/train_speed_contrastive_normal.out
#SBATCH -e /data/shinpaul14/outputs/train_speed_contrastive_normal.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
#---------------------------------------------------
# exp_name="tsm-k400-speed-contrastive_xbd_sgd_self_not_start"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V1"
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/self/tsm_r50_1x1x3_k400_100e_ekmmsada_rgb_contrastive_xbd_sgd_normal_frozen_cls_no_same_start.py"
...
# #--------------------------------------------------
# exp_name="tsm-k400-speed-contrastive_xbd_sgd_self_same_start"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V1"
...
# exp_name1="tsm-k400-speed-contrastive_xbd_sgd_self_same_start"
# exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_resfrozen_rgb.py'
# exp_name="tsm-k400-speed-contrastive_xbd_sgd_self_same_start"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V2_cls"
...
# exp_name="tsm-k400-speed-contrastive_xbd_sgd_self_same_start"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V2_end"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_rgb.py'
# PORT=7070 bash /data/shinpaul14/projects/mmaction2/tools/dist_train.sh $config 4 --cfg-options work_dir=/data/shinpaul14/projects/mmaction2/work_dirs/$exp_section/$exp_name/train_D1_test_D1 data.train.domain='D1' data.val.domain='D1' load_from="./work_dirs/$exp_section1/$exp_name1/train_D1_test_D1/latest.pth" total_epochs=100  --validate --deterministic
...
# exp_name1="tsm-k400-speed-contrastive_xbd_sgd_self_not_start"
# exp_section1="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V1"
# config='/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/tsm_baseline/tsm_r50_1x1x3_100e_ekmmsada_resfrozen_rgb.py'
# exp_name="tsm-k400-speed-contrastive_xbd_sgd_self_not_start"
# exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_self_contrastive_V2_cls"
