...
#SBATCH -o /data/jongmin/outputs/train_color_contrastive_xd_sgd_color_temp_07_e20.out
#SBATCH -e /data/jongmin/outputs/train_color_contrastive_xd_sgd_color_temp_07._e20err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
# config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/color_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_momen.py"
