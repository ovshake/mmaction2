...
#SBATCH -o /data/shinpaul14/outputs/train_contrastive_color_decay_001.out
#SBATCH -e /data/shinpaul14/outputs/train_contrastive_color_decay_001.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
# config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/color_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_decay_001.py"
