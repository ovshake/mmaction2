...
#SBATCH -o /data/jongmin/outputs/train_color_contrastive_temp_30.out
#SBATCH -e /data/jongmin/outputs/train_color_contrastive_temp_30.err
#SBATCH --time 2-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
#--------------------------------------------------
exp_name="tsm-k400-color-contrastive_xd_sgd_color_temp_30"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_V1"
config="/data/jongmin/projects/mmaction2_paul_work/configs/recognition/tsm/color_contrastive_stage1/tsm_r50_1x1x3_k400_100e_colorspatial_ekmmsada_rgb_contrastive_xd_sgd_color_frozen_cls_temp_3.py"
...
exp_name1="tsm-k400-color-contrastive_xd_sgd_color_temp_30"
