...
#SBATCH -o /data/shinpaul14/outputs/simsiam_xdb_sgd_color_NO_CLS_TSMconstructor.out
#SBATCH -e /data/shinpaul14/outputs/simsiam_xdb_sgd_color_NO_CLS_TSMconstructor.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/train_scratch/tsm_r50_1x1x3_100e_colorspatial_ekmmsada_rgb_real_simsiam_xdb_sgd_color_frozen_cls_TSMconstructor.py"
