#!/bin/bash
#SBATCH --gres=gpu:4
#SBATCH -J color_contrastive_xbd_color_sgd_with_cls_new
#SBATCH -o /data/shinpaul14/outputs/color_contrastive_xbd_color_sgd_with_cls.out
#SBATCH -e /data/shinpaul14/outputs/color_contrastive_xbd_color_sgd_with_cls.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[10]
...
exp_name="tsm-k400-color-contrastive-xbd-color-sgd_with_cls"
exp_section="tsm_r50_1x1x3_100e_ekmmsada_rgb_color_contrastive_v1"
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/simsiam_kinetic/tsm_r50_1x1x3_100e_colorspatial_ekmmsada_rgb_real_simsiam_xdb_sgd_color_all_vid_w_cls.py"
