...
#SBATCH -o /data/shinpaul14/outputs/color_contrastive_xbd_color_sgd.out
#SBATCH -e /data/shinpaul14/outputs/color_contrastive_xbd_color_sgd.err
#SBATCH --time 1-0
#SBATCH -p batch_grad
#SBATCH -x ai[5,10]
...
config="/data/shinpaul14/projects/mmaction2/configs/recognition/tsm/simsiam_NO_CLS/tsm_r50_1x1x3_100e_colorspatial_ekmmsada_rgb_real_simsiam_xdb_sgd_color_frozen_cls_bias_false.py"
